...
func (v *collator_[V]) compareArrays(
	...
	if v.currentDepth_ == v.maximumDepth_ {
		var message = fmt.Sprintf(
			"The maximum traversal depth was exceeded: %v",
			v.currentDepth_,
		)
		panic(message)
	}
...
func (v *collator_[V]) compareInterfaces(
	first ref.Value,
	second ref.Value,
) bool {
...
func (v *collator_[V]) compareMaps(
	first ref.Value,
	second ref.Value,
) bool {
	// Check for maximum traversal depth.
...
func (v *collator_[V]) compareIntrinsics(
	first ref.Value,
	second ref.Value,
) bool {
...
func (v *collator_[V]) compareSequences(
	first ref.Value,
	second ref.Value,
) bool {
...
func (v *collator_[V]) rankBooleans(
	first bool,
	second bool,
) Rank {
	if !first && second {
...
func (v *collator_[V]) rankInterfaces(
	first ref.Value,
	second ref.Value,
) Rank {
	var typeRef = first.Type() // We know the structures are the same type.
...
func (v *collator_[V]) rankIntrinsics(
	first ref.Value,
	second ref.Value,
) Rank {
...
func (v *collator_[V]) rankSequences(
	first ref.Value,
	second ref.Value,
) Rank {
...
func (v *collator_[V]) rankStrings(
	first string,
	second string,
) Rank {
	if first < second {
...
func (v *collator_[V]) rankStructures(
	first ref.Value,
	second ref.Value,
) Rank {
...
func (v *collator_[V]) rankUnsigned(
	first uint64,
	second uint64,
) Rank {
	if first < second {
